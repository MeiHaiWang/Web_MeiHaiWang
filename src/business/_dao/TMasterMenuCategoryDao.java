...
public abstract class TMasterMenuCategoryDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TMasterMenuCategoryInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
