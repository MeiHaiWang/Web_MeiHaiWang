...
public abstract class TMasterHairTypeDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TMasterHairTypeInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
