...
public abstract class TMasterRecommendDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TMasterRecommendInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
