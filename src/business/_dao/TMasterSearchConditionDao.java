...
public abstract class TMasterSearchConditionDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TMasterSearchConditionInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
