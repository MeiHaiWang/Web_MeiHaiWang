...
public abstract class TReservationDao extends BaseDao {
	...
	/**
	 * {@link TReservationInfo} 一覧を取得します
	 * 
	 * @param dbConnection
	 * @param columnName
	 * @param value
	 ...
	 * @throws SQLException
	 */
	public List<TReservationInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
