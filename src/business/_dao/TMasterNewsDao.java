...
public abstract class TMasterNewsDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TMasterNewsInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
