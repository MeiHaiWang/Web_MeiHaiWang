...
public abstract class THairSalonMasterDao extends BaseDao {
	...
	/**
	 * {@link THairSalonMasterInfo} を作成します。
	 * @param rs
	 * @return
	 * @throws SQLException
	 */
	...
	/**
	 * {@link THairSalonMasterInfo} を取得します。
	 * @param dbConnection
	 * @param id PK
	 * @return
	 * @throws SQLException
	...
	/**
	 * {@link THairSalonMasterInfo} 一覧を取得します
	 * 
	 * @param dbConnection
	 * @param columnName
	 * @param value
	 ...
	 * @throws SQLException
	 */
	public List<THairSalonMasterInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
