...
public abstract class TClaimDao extends BaseDao {
	 ...
	 * @throws SQLException
	 */
	public List<TClaimInfo> getByColumns(DBConnection dbConnection, Map<String, Object> map, Integer offset, Integer count, String orderColumn, String direction) throws SQLException {
