...
///@WebServlet(name="GetSearchStylistServlet",urlPatterns={"/api/:version/stylist_list"})
public class GetSearchStylistAction  extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		//service excute
		GetSearchStylistService searchStylistService = new GetSearchStylistService();
		searchStylistService.excuteService(request, response);
