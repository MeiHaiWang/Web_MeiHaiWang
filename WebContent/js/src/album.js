...
*/
	 ...
	 * アルバムにエリア追加
	 */
	  var AlbumCountry = React.createClass({displayName: "AlbumCountry",
		  ...
		  var AlbumArea = React.createClass({displayName: "AlbumArea",
		    getDefaultProps:function() {
		      return {
		        area: ['']
		      };
		 ...
		 */
		  ...
		  var AlbumMessage = React.createClass({displayName: "AlbumMessage",
			    getDefaultProps:function() {
			      return {
			        t_album_message: ['']
			      };
			    ...
			    render:function() {
			    	return (
			    			React.createElement(Input, {type: "text", value: this.state.t_album_message, onChange: this.changeText})
			    		);
				    }
				  });
...
*/
  ...
  var AlbumImagePath = React.createClass({displayName: "AlbumImagePath",
	    ...
	    render:function() {
	      ...
	      return (
	        React.createElement("div", null, 
	        	React.createElement("img", {className: "image", src: this.state.t_hairStyle_imagePath?this.state.t_hairStyle_imagePath:'img/notfound.jpg', 
	        	 width: "0%", height: "0%"})
	        )
	      );
	    }
  ...
  var AlbumImagePath2 = React.createClass({displayName: "AlbumImagePath2",
	    getDefaultProps:function() {
	        return {
	    ...
	    render:function() {
	      ...
	      return (
	        React.createElement("div", null, 
	        	React.createElement("img", {className: "image", src: this.state.t_hairStyle_imagePath2?this.state.t_hairStyle_imagePath2:'img/notfound.jpg', 
	        	 width: "0%", height: "0%"})
	        )
	      );
	    }
  ...
  var AlbumImagePath3 = React.createClass({displayName: "AlbumImagePath3",
	    getDefaultProps:function() {
	        return {
	    ...
	    render:function() {
	      ...
	      return (
	        React.createElement("div", null, 
	        	React.createElement("img", {className: "image", src: this.state.t_hairStyle_imagePath3?this.state.t_hairStyle_imagePath3:'img/notfound.jpg', 
	        	 width: "0%", height: "0%"})
	        )
	      );
	    }
    ...
    render:function() {
      ...
      */
      var album = this.state.album_list.map(function(album) {
    	...
    	React.createElement("td", null, React.createElement("img", {src: album.t_hairStyle_imagePath?album.t_hairStyle_imagePath:'img/notfound.jpg'})), 
        React.createElement("td", null, React.createElement("img", {src: album.t_hairStyle_imagePath2?album.t_hairStyle_imagePath2:'img/notfound.jpg'})), 
        React.createElement("td", null, React.createElement("img", {src: album.t_hairStyle_imagePath3?album.t_hairStyle_imagePath3:'img/notfound.jpg'})), 
      ...
      return (
    	        React.createElement("div", null, 
    	          ...
    	          React.createElement("tr", null, 
    	            ...
    	            React.createElement("th", null, "照片"), React.createElement("th", null, "照片2"), React.createElement("th", null, "照片3"), React.createElement("th", null, "编辑")
    	          ), 
    	            album
    	          )
    	          )
...
*/
  ...
  */
  ...
  var component_album_image_path2 = React.render(React.createElement(AlbumImagePath2, null), document.getElementById('album_image_path2'));
  var component_album_image_path3 = React.render(React.createElement(AlbumImagePath3, null), document.getElementById('album_image_path3'));
  var component_album_list = React.render(React.createElement(AlbumList, null), document.getElementById('album_list_info'));

  //area
  var component_album_country = React.render(React.createElement(AlbumCountry, null), document.getElementById('album_country'));
  var component_album_area = React.render(React.createElement(AlbumArea, null), document.getElementById('album_area'));
  //message
  var component_album_message = React.render(React.createElement(AlbumMessage, null), document.getElementById('album_message'));
