  ...
  var AlbumList = React.createClass({displayName: "AlbumList",
    ...
    render:function() {
      ...
      */
      var album = this.state.album_list.map(function(album) {
      	...
      	React.createElement("td", null, index++), 
      	 React.createElement("td", null, album.gender), React.createElement("td", null, album.hair_length), React.createElement("td", null, album.feeling), React.createElement("td", null, 
          React.createElement("img", {src: album.t_hairStyle_imagePath?album.t_hairStyle_imagePath:'img/notfound.jpg'})), React.createElement("td", null, 
          React.createElement("img", {src: album.t_hairStyle_imagePath2?album.t_hairStyle_imagePath2:'img/notfound.jpg'})), React.createElement("td", null, 
          React.createElement("img", {src: album.t_hairStyle_imagePath3?album.t_hairStyle_imagePath3:'img/notfound.jpg'})
      ...
      */
      return (
    	        React.createElement("div", null, 
    	          React.createElement("table", null, React.createElement("tr", null, 
    	            React.createElement("th", null, "No."), 
    	            React.createElement("th", null, "性別"), React.createElement("th", null, "長さ"), React.createElement("th", null, "イメージ"), 
