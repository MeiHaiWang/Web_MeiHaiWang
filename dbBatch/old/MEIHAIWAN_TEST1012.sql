...
--
-- Host: localhost
-- Generation Time: 2015 年 10 月 12 日 15:09
-- サーバのバージョン： 5.6.24
-- PHP Version: 5.5.24
...
(1, 'testSalonだよ！', NULL, NULL, NULL, '27', '1,2,3,4,5,6,7,8,9', 0, 'テストだよ！', 'null,1', '3,1,2,4,12,17', NULL, 'http://localhost:8080/MeiHaiWangWebProject/upload/32.jpeg,http://localhost:8080/MeiHaiWangWebProject/upload/31.jpeg,http://localhost:8080/MeiHaiWangWebProject/upload/29.jpeg,img/notfound.jpg', NULL, '2,3,4,2,4', NULL, NULL, NULL, 'mail1', 'password', '10:00', '20:00', '终年无休', 0, 0, 'http;//war', '', NULL, 0, 0, NULL, '0', 0, 1, '2,5,16,13,15', NULL, NULL),
...
(1, 'test1', 1, 1, 0, 1, '3', NULL, 1, NULL, 0, '1,2'),
(2, '', 0, 0, 0, 1, '1', 'http://localhost:8080/MeiHaiWangWebProject/upload/19.jpeg,http://localhost:8080/MeiHaiWangWebProject/upload/20.jpeg,http://localhost:8080/MeiHaiWangWebProject/upload/21.jpeg', 1, '1970-01-01 09:00:00', 0, '1,8'),
(3, 'a', 0, 0, 0, 1, '2', 'img/notfound.jpg,img/notfound.jpg,img/notfound.jpg', 1, '1970-01-01 09:00:00', 0, '1,28,31,35');
...
(2, 1, 1, 1, '2015-10-05 11:00:00', 0, '1', 1, '1'),
(3, 1, 1, 2, '2015-10-17 10:00:00', 0, '3,5', 1, ''),
(4, 1, 1, 4, '2015-10-06 18:00:00', 0, '4,5', 1, ''),
(5, 5, 1, 3, '2015-10-06 10:00:00', 0, '3,5', 1, ''),
(6, 1, 1, 3, '2015-10-07 10:00:00', 0, '4', 1, ''),
(7, 18, 1, 3, '2015-10-05 15:00:00', 0, '5', 1, ''),
(8, 1, 1, 1, '2015-10-05 11:00:00', 0, '6,3', 1, ''),
(9, 31, 1, 1, '2015-10-13 10:00:00', 0, '1,3', 1, ''),
(10, 5, 1, 3, '2015-10-12 10:00:00', 0, '6,3', 1, ''),
(11, 5, 1, 1, '2015-10-13 09:00:00', 0, '3,8', 1, ''),
(12, 1, 1, 3, '2015-10-12 09:00:00', 0, '1,3', 1, ''),
(13, 1, 1, 3, '2015-10-12 09:00:00', 1, '1,3', 1, ''),
(14, 0, 1, 1, '2015-10-12 09:00:00', 0, 'R1', 1, ''),
...
--
ALTER TABLE `t_coupon`
  MODIFY `t_coupon_Id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `t_image`
  MODIFY `t_image_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=39;
--
...
--
ALTER TABLE `t_menu`
  MODIFY `t_menu_menuId` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `t_user`
  MODIFY `t_user_Id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=37;
